...
cleaning_result.to_csv('cleaned_dataset.csv', index=False)

data = pd.read_csv(os.path.join(data_dir, 'cleaned_dataset.csv'))
...
result_df.to_csv('sentiment_benchmark.csv', index=False)
